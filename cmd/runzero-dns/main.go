// Copyright 2018-2019 runZero, Inc
//
//
...
var (
	...
	subdomain  = flag.String("subdomain", "v1.nxdomain.us", "subdomain handled by runzero-dns")
)
...
func main() {
	...
	log.Printf("runzero-dns-server starting on port %d", *port)
